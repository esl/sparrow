defmodule Sparrow.APNS.Errors do
  ...
  def get_error_description(400, "BadDeviceToken"),
    do: "The specified device token was bad.
      Verify that the request contains a valid token and that the token matches the environment."

  def get_error_description(400, "BadExpirationDate"), do: "The apns-expiration value is bad."
  def get_error_description(400, "BadMessageId"), do: "The apns-id value is bad."
  def get_error_description(400, "BadPriority"), do: "The apns-priority value is bad."
  ...
  def get_error_description(400, "DuplicateHeaders"), do: "One or more headers were repeated."
  ...
  def get_error_description(403, "BadCertificate"), do: "The certificate was bad."
  ...
  def get_error_description(403, "Forbidden"), do: "The specified action is not allowed."
  ...
  def get_error_description(413, "PayloadTooLarge"),
    do: "The message payload was too large.
  ...
  def get_error_description(500, "InternalServerError"), do: "An internal server error occurred."
  def get_error_description(503, "ServiceUnavailable"), do: "The service is unavailable."
